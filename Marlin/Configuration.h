...
#define STRING_CONFIG_H_AUTHOR "(j54n1n, default config)" // Who made the changes.
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  21.08
    #define DEFAULT_Ki   2.77
    #define DEFAULT_Kd  40.15
  #endif
#else
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 85.48, 85.48, 533.33, 104.70 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 30000, 30000, 10, 45 }
